...
<div class="maincol_full_header">
	<?php if( !($locationId = JRequest::getVar('locationId')) ):?>
		<div id="rss"><a href="<?php echo JRoute::_('index.php?option=com_enmasse&controller=rss&task=listdeal'); ?>"><img src="components/com_enmasse/theme/<?php echo $theme?>/images/rss.gif" alt="All Deals RSS Feed" title="RSS Feed"/></a></div>
	<?php else :?>
		<div id="rss"><a href="<?php echo JRoute::_('index.php?option=com_enmasse&controller=rss&task=location&locationId=' . $locationId); ?>"><img src="components/com_enmasse/theme/<?php echo $theme?>/images/rss.gif" alt="All Deals RSS Feed" title="RSS Feed"/></a></div>
	<?php endif;?>
