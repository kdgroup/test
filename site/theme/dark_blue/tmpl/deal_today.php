...
<div class="deal">	
	<div class="main_deal">
		<div id="rss"><a href="<?php echo JRoute::_('index.php?option=com_enmasse&controller=rss&task=today')?>"><img src="components/com_enmasse/theme/<?php echo $theme?>/images/rss.gif" alt="Today Deal RSS Feed" title="RSS Feed"/></a></div>		
		...
		<div class="deal_left">
			<div id="price_tag">
				<div id="price_tag_cont">
					...
					<?php else :?>
						...
						{ echo'#';}else{ ?>index.php?option=com_enmasse&controller=shopping&task=addToCart&dealId=<?php echo $deal->id .'&slug_name=' .$deal->slug_name;?>&referralid=<?php echo JRequest::getVar('referralid'); ?>&typeId=none<?php } ?>" class="buy"><?php echo JText::_('Buy')?></a>
						<?php
						if($deal->types) 
						{
						?>
			...
			<div class="sharing">
				...
				<a href="javascript:void mailToFriend()"><img src="components/com_enmasse/images/social_media/email.png" alt="Mail to your friend"></a>
			</div>
		...
		<div class="popupContBuy hidden" id='popupContBuynormal' style="left:215px; top:159px;">
            <div class="innerPopContBuy">
		 	...
		 	<a href="javascript:void(0)" id="enmasse_attr_close"><img src="components/com_enmasse/images/closebutton.png" /></a>
