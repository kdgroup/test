...
<div class="maincol_full_header">
	...
	<?php if( !($locationId = JRequest::getVar('locationId')) ):?>
		<div id="rss"><a href="<?php echo JRoute::_('index.php?option=com_enmasse&controller=rss&task=listexpireddeal'); ?>"><img src="components/com_enmasse/theme/<?php echo $theme?>/images/rss.gif" alt="Expired Deals RSS Feed" title="RSS Feed"/></a></div>
	<?php else :?>
		<div id="rss"><a href="<?php echo JRoute::_('index.php?option=com_enmasse&controller=rss&task=location&locationId=' . $locationId); ?>"><img src="components/com_enmasse/theme/<?php echo $theme?>/images/rss.gif" alt="Expired Deals RSS Feed" title="RSS Feed"/></a></div>
	<?php endif;?>
</div>
...
<div class="maincol_full_content">
	...
	<?php else:?>
		...
		<?php foreach ($dealList as $i => $oDeal):?>
			...
			?>
			<div class="deal_small <?php if($i%2 != 0){echo 'last';} ?>">
				<div class="image">
					<div class="inner">
