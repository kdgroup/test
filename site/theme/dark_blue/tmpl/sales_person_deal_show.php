...
?>
	...
	<table class="noBorder tbSaleDeal">
		<tr>
			<td>
				...
				<input type="submit" class="btnSubmit" value="<?php echo JTEXT::_('SALE_SEARCH_BUTTON');?>" /> 
				<input type="button" class="btnSubmit" value="<?php echo JTEXT::_('SALE_RESET_BUTTON');?>" onClick="location.href='<?php echo JRoute::_('index.php?option=com_enmasse&controller=salesPerson&task=dealShow')?>'" />
                                </div>
			</td>
		</tr>
	</table>
