...
jQuery(function() {
	...
	if(checkAcymailing())
	{
	    ...
	    jQuery('.acyfield_name input:text').attr('size', 50);
	    jQuery(".acyfield_email input:text").attr('size', 50)
	    
	    var name = jQuery(".acyfield_name input:text"),
	    email = jQuery(".acyfield_email input:text"),
