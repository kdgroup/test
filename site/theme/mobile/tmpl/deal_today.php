...
<div class="row lstItemSmall">
	<ul>
		...
		<li>
        	<div class="blockLeft">
                <a href="index.php?option=com_enmasse&controller=shopping&task=addToCart&dealId=<?php echo $deal->id .'&slug_name=' .$deal->slug_name;?>&referralid=<?php echo JRequest::getVar('referralid'); ?>&typeId=<?php echo($type->id); ?>">
                	<p class="title">
                    	<span class="dealTitleSmall"><?php echo($type->name); ?></span>
                    	<span><b><?php echo  EnmasseHelper::displayCurrency($type->origin_price);?></b> <?php echo JText::_('DEAL_TYPE_VALUE') ?> - <b><?php echo(DealType::percent($type->origin_price,$type->price)); ?>%</b> <?php echo JText::_('DEAL_TYPE_OFF') ?> - <?php echo JText::_('DEAL_TYPE_SAVE') ?> <b><?php echo EnmasseHelper::displayCurrency(DealType::minus($type->origin_price,$type->price)); ?></b></span>
                    </p>
                    <strong><?php echo(EnmasseHelper::displayCurrency($type->price));?></strong>
                </a>
            </div><!--blockLeft-->
            <div class="blockRight">
            	<a href="index.php?option=com_enmasse&controller=shopping&task=addToCart&dealId=<?php echo $deal->id .'&slug_name=' .$deal->slug_name;?>&referralid=<?php echo JRequest::getVar('referralid'); ?>&typeId=<?php echo($type->id); ?>&buy4friend=1"><strong><?php echo JText::_('BUY')?></strong><span><?php echo JText::_('FOR_FRIEND')?></span></a>
            </div>
        </li>
