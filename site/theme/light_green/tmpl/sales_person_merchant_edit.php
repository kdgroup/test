...
function validateForm()
{
	...
	var idvalar = idval.split('-');
	var idnum = idvalar[1];//number of clone
	
	
	var flaggg = false;
	var isChecked = jQuery('.admintable #remove-' +  idnum).attr('checked')?true:false;
...
//alert(jQuery('.admintable #remove-' +  idnum).val() + ' ' +idnum);
