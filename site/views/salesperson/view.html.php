		...
		switch ($task) 
		{
    		case 'dealEdit':
				...
				if($cid[0]!=0)
				{
					...
					$dealTypeList = JModel::getInstance('dealtype','enmasseModel')->getDealTypeListByIdDeal($cid[0]);
				...
				$this->merchantList = JModel::getInstance('merchant','enmasseModel')->getBySalePerson($salesPersonId);
