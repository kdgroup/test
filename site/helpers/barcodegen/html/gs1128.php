...
if($identifiersPost != '') {
	...
	for($i = 0; $i < $c; $i++) {
		...
		$text2display .= '<input type="text" name="textTemp[0][]" value="' . $identifiersIdPost[$i] . '" style="width:40px;" /> - <input type="text" name="textTemp[1][]" style="width:295px;" value="' . $identifiersContentPost[$i] . '" /><a href="javascript:removeIdentifier(' . $i . ');"><img src="delete.png" alt="Barcode Image" style="border:0px; margin-left:5px; margin-top:5px;" /></a>';
		$text2display .= '</div>';
	}
