...
<tr><td colspan="6" height="10"></td></tr>
    <tr>
		...
		<td align="center" valign="top">
		<?php $link = JRoute::_("index.php?option=com_enmasse&controller=sociallogin");
		echo "&nbsp;<a href=\"$link\"><img src=\"components/com_enmasse/images/sociallogin.png\" /></a>"; ?>
		<br/>
		<b><?php echo JText::_('S_SOCIAL_LOGIN');?></b>
		</td>
