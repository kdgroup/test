...
<table class="admintable">
	...
	<tr>
		...
		<td><input class="text_area" type="text" name="minute_release_invty"
			id="minute_release_invty" size="10"
			value="<?php echo $row->minute_release_invty;?>" /></td>
	</tr>
</table>
...
<!-- Begin - bill setting -->
<fieldset class="adminform"><legend><?php echo JText::_('SECURITY_CODE')?></legend>
<table class="admintable">
	<tr>
		<td width="140" align="right" class="key"><span><?php echo JHTML::tooltip(JTEXT::_('ENABLE_THIS_FEATURE'),JTEXT::_('ENABLE_THIS_FEATURE'), 
                    '', JTEXT::_('ENABLE_THIS_FEATURE'));?></span>
        </td>
		<td>
			<?php echo JHtml::_('select.booleanlist', 'enable_security_code','class="inputbox"', $row->enable_security_code)?>
		</td>
	</tr>
