    ...
    <div class="width-100 fltlft">
        <fieldset class="adminform">
            ...
            <ul id="prod_upload_image">
                ...
                <li style="width:100%;">
                        <input type="file" name="image[]" class="inputbox"><a style="margin-top:8px;display:block;" href="javascript:;" onclick="deleteImageUpload(this);"><?php echo JText::_('DELETE_INFUT_FILE_LABEL');?></a>
                </li>
                
                <li class="cloneObj" style="width:100%;display:none;">
                        <input type="file"  name="image[]" class="inputbox"><a style="margin-top:8px;display:block;" href="javascript:;" onclick="deleteImageUpload(this);"><?php echo JText::_('DELETE_INFUT_FILE_LABEL');?></a>
                </li>
            </ul>
            <div class="clr"></div>
...
<script>
	...
	var clone = cloneObj.clone().setStyle('display','');
